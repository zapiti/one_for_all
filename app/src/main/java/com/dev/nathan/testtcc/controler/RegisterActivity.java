...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button reg_login_btn = findViewById(R.id.reg_login_btn);
        load = findViewById(R.id.avi2contentReg);
                ...
                if(!TextUtils.isEmpty(email) && !TextUtils.isEmpty(pass) & !TextUtils.isEmpty(confirm_pass)){
                    ...
                    if(pass.equals(confirm_pass) ){
                        if(confirm_pass.length() >= 7 ) {
                            ...
                            Toast.makeText(RegisterActivity.this, "Senha muito Fraca !", Toast.LENGTH_LONG).show();

                        }
                    } else {

                        Toast.makeText(RegisterActivity.this, "Confirme a senha e o campo da senha não corresponde.", Toast.LENGTH_LONG).show();
